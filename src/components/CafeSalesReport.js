...
return (
  <div className="sales report-container">
    ...
    <div className="filter-section-table">
      <table className="filter-layout-table">
        <tbody>
          <tr>
            <td>
            ...
            <td>
              <label className="tb-label">By Item</label>
                ...
                setCategory("");      // ✅ ADD THIS LINE
                setDishGroup("");     // ✅ ADD THIS LINE
              }}>
                <option value="">-- Select --</option>
          ...
          {orderSales === "Itemwise" && (
            <tr>
              ...
              <td colSpan="2">
                <div className="checkbox-group-table">
              ...
              <td colSpan="3"></td>
                    ...
                    {/* ✅ ADD THIS - By Item Category & Dish Group Filters */}
                    {/* By Item (Month/Qty) - ONLY Category & Dish Group, NO Chart/Post Dated */}
          {(byItem === "Month" || byItem === "Qty") && (
            <tr>
              <td>
                <label className="tb-label">Category</label>
                <div className="lov-input-group">
              ...
              <td>
                ...
                <div className="lov-input-group">
                  <input value={dishGroup} onChange={(e) => setDishGroup(e.target.value)} placeholder="Select Dish Group" />
                  <button type="button" className="lov-btn" onClick={() => {setShowDishGroupLOV(true); }}>...</button>
                </div>
              </td>
              <td colSpan="4">  {/* Empty cells - NO Chart, NO POST DATED */} </td>
            </tr>
          )}
        </tbody>
      </table>
